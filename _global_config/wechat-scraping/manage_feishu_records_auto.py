#!/usr/bin/env python3
"""
Feishu Records Management Script - Auto Execute Version
Automatically handles duplicate detection, deletion, and record updates
"""
...
def merge_duplicate_info(access_token, duplicates):
    """
...
def handle_duplicates(access_token, duplicates):
    """
...
def main():
    ...
    print("\n步骤1: 合并信息...")
    merged_count = merge_duplicate_info(access_token, duplicates)
    print(f"\n✓ 合并了 {merged_count} 条记录的信息")

    # Step 2: Delete duplicates
    print("\n步骤2: 删除重复...")
    deleted_count = handle_duplicates(access_token, duplicates)
