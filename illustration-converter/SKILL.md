...
description: "将真实植物照片转换为多种艺术插画风格（水彩/国画/彩铅/油画/彩绘），支持系列图和步骤图生成"
license: MIT
version: "2.0"
---
...
将真实植物照片转换为艺术插画，支持5大风格类别（水彩/国画/彩铅/油画/彩绘），每种风格区分东方/西方美感。
...
**v2.0 更新**：
- 重新设计工作流程：系列图和步骤图独立生成
- 步骤图统一使用原始照片作为参考（不再使用系列图）
- 步骤图 prompt 通用化，适用于所有10种画风
- 简化用户决策流程
