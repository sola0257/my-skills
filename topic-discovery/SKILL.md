...
#### 策略A：起号期（0-500粉）- 生成商品建议

**目标**：输出结构化的商品建议，可直接录入飞书商品库表

**执行逻辑**：
1. 基于选题关键词，推荐3-5个待上架商品
2. 每个商品包含完整的飞书表格字段
3. 输出格式可直接复制到飞书多维表格
...
|---------|---------|------|------|---------|---------|------|
| 龟背竹盆栽（中型） | 观叶植物 | 39.9-59.9 | 50 | 高 | 小红书/公众号 | 契合春季养护热点，搜索量高，适合新手 |
| 多肉组合盆栽（3株） | 多肉植物 | 29.9-39.9 | 100 | 高 | 小红书/抖音 | 高颜值，易养护，适合办公桌场景 |
| 绿萝水培套装 | 观叶植物 | 19.9-29.9 | 80 | 中 | 全平台 | 入门级商品，转化率高 |
```
